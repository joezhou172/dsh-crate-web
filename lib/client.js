...
`;
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dl", {
						...
						children: [
							...
							"canContinue",
							"suggestedNextStep"
						].filter((field) => diagnostic[field] !== void 0).map((field) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: field }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: display(diagnostic[field]) })] }, field))
					}),
				...
				children: [
					...
					tab === "history" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
						...
						children: history.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
							...
							] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: item.status })]
						}, `${item.time}-${index}`))
					}) : null,
		...
		*/
		...
		const en = {
			...
			confirmImport: "Preflight passed. Import as a new Profile?",
			working: "Working…",
		...
		const zh = {
			...
			confirmImport: "Preflight 已通过。要作为新 Profile 导入吗？",
			working: "处理中…",
			noReport: "暂无报告。",
